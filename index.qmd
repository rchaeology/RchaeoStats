...
| Component | Description | Materials | Duration |
|----|----|----|----|
| Visualising Data | Visualising the cleaned data with [ggplot2]{.pkg}  | Code-along: [05 - Visualising Data](/docs/05_visualising-data.qmd) | ~100 mins |
| Transforming Data | Transforming the cleaned data with [dplyr]{.pkg}  | Code-along: [06 - Transforming Data](/docs/06_transforming-data.qmd) | ~120 mins |
